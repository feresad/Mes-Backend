...
public class ConsommationApplication {
	...
	CommandLineRunner start(ConsoRepository ConsomRepository) {
		return args -> {
			ConsomRepository.save(new consommation(null, "1 kg courant , 2 kg matiere Premier",6L,3L));
			ConsomRepository.save(new consommation(null, "24 kg courant , 03 kg matiere Premier",5L,2L));
